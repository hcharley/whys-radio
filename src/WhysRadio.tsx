...
export class WhysRadio extends React.Component<
  {},
  {
    streamTitle: string;
    playing: boolean;
      ...
      <View style={styles.container}>
        ...
        {/* <View style={styles.navigation}>
            <NavigationLink
              text="Donate"
              onPress={() => {
                WhysRadio.openLink('http://www.whysradio.org/donate.php');
              }}
            />
            <NavigationLink
              text="Schedule"
              onPress={() => {
                WhysRadio.openLink('http://www.whysradio.org/schedule.php');
              }}
            />
            <NavigationLink
              text="Recently played"
              onPress={() => {
                WhysRadio.openLink('http://www.whysradio.org/nowplaying.php');
              }}
            />
          </View> */}
